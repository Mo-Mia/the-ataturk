...
describe("admin dataset version routes", () => {
  it("lists, creates a fork, and activates dataset versions", async () => {
    testDatabase = createServerTestDatabase("dataset-versions");
    const app = buildApp();
    ...
    try {
      ...
      expect(create.json()).toMatchObject({ id: "v1-test", parent_version_id: "v0-stub" });
      ...
      const activate = await app.inject({
        method: "POST",
        url: "/api/dataset-versions/v1-test/activate"
      });
